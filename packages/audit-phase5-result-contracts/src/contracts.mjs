...
export const PHASE5_RESULT_CONTRACTS = Object.freeze({
  'hardhat-test-v1': Object.freeze({
    parserVersion: 'hardhat-test-parser-v1',
    recordKey: 'hardhatTests',
    evidenceType: 'hardhat-test-summary',
    summaryKeys: Object.freeze(['passed', 'failed', 'skipped', 'total'])
  }),
  'echidna-v1': Object.freeze({
    parserVersion: 'echidna-parser-v1',
    recordKey: 'echidnaProperties',
    evidenceType: 'echidna-campaign-summary',
    summaryKeys: Object.freeze(['passed', 'failed', 'total', 'seed'])
  }),
  'mutation-v1': Object.freeze({
    parserVersion: 'mutation-parser-v1',
    recordKey: 'mutationResults',
    evidenceType: 'mutation-summary',
    summaryKeys: Object.freeze(['killed', 'survived', 'timedOut', 'invalid', 'total', 'mutationScore'])
  }),
  'dependency-scan-v1': Object.freeze({
    parserVersion: 'dependency-scan-parser-v1',
    recordKey: 'dependencyFindings',
    evidenceType: 'dependency-scan-summary',
    summaryKeys: Object.freeze(['critical', 'high', 'moderate', 'low', 'unknown', 'total'])
  })
});
...
export const RESULT_TOP_LEVEL_KEYS = Object.freeze([
  'schemaVersion', 'profileId', 'parserVersion', 'classification', 'durationMs', 'exitCode',
  ...PROFILE_RECORD_KEYS, 'evidence', 'artifacts', 'parserErrors', 'summary'
]);
export const RESULT_CLASSIFICATIONS = Object.freeze([
  'success', 'findings', 'timeout', 'cancelled', 'resource_exhaustion', 'malformed_output', 'parser_error'
]);
