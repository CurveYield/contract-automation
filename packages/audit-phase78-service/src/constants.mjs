...
'campaign.create','campaign.read','fork.action','fork.checkpoint','fork.create','fork.delete','fork.export','fork.read','merge.create','merge.read','provenance.read','report.publish','report.read','share.create','share.revoke']);
...
export const OPERATION_SCOPE=Object.freeze({
 'fork.create':'audit:submit','fork.read':'audit:read','fork.action':'audit:submit','fork.checkpoint':'audit:submit','fork.export':'audit:submit','fork.delete':'audit:submit',
