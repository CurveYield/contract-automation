...
export const TIER3_CONTROLLER_RELEASE_V1 = 'ai-auditor-deep-assurance-v6@16.13.0';
export const TIER3_ACTIVE_NETWORKS_V1 = Object.freeze(['ethereum', 'base']);
export const TIER3_DEFAULT_NETWORK_V1 = 'base';
...
export function assertControllerCompatibilityV1(value) {
  ...
  if (value.adapterVersion !== TIER3_CONTROLLER_ADAPTER_VERSION_V1) throw new TypeError('adapterVersion is not supported');
  text(value.controllerRelease, 'controllerRelease');
  text(value.automationRelease, 'automationRelease');
  if (value.controllerRelease !== TIER3_CONTROLLER_RELEASE_V1) throw new TypeError('controllerRelease is not compatible with Tier 3 v1');
...
export function normalizeControllerProjectionV1(value) {
  assertControllerCompatibilityV1(value);
