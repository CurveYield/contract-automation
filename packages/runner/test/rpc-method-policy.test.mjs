...
const expectedMethods = [
  'eth_accounts', 'eth_getBalance', 'eth_getCode', 'eth_getProof', 'eth_getStorageAt',
  'eth_blockNumber', 'eth_getBlockByHash', 'eth_getBlockByNumber', 'eth_newBlockFilter',
  'eth_getBlockReceipts', 'eth_getBlockTransactionCountByHash', 'eth_getBlockTransactionCountByNumber',
  'eth_chainId', 'eth_protocolVersion', 'net_listening', 'net_version', 'net_peerCount',
  'eth_syncing', 'eth_hashrate', 'trace_filter', 'trace_rawTransaction', 'trace_block',
  'trace_replayBlockTransactions', 'debug_traceBlockByHash', 'debug_traceBlockByNumber',
  'trace_transaction', 'debug_traceTransaction', 'trace_replayTransaction', 'trace_callMany',
  'trace_get', 'trace_call', 'debug_traceCall', 'eth_getLogs', 'eth_newFilter',
  'eth_getFilterChanges', 'eth_uninstallFilter', 'eth_getFilterLogs', 'eth_call',
  'eth_sendRawTransaction', 'eth_feeHistory', 'eth_estimateGas', 'eth_gasPrice',
  'eth_createAccessList', 'eth_maxPriorityFeePerGas', 'eth_getUncleByBlockHashAndIndex',
  'eth_getUncleByBlockNumberAndIndex', 'eth_getUncleCountByBlockHash',
  'eth_getUncleCountByBlockNumber', 'eth_coinbase', 'eth_mining', 'eth_subscribe',
  'eth_unsubscribe', 'eth_getTransactionByHash', 'eth_getTransactionCount',
  'eth_getTransactionReceipt', 'eth_newPendingTransactionFilter',
  'eth_getTransactionByBlockHashAndIndex', 'eth_getTransactionByBlockNumberAndIndex',
  'txpool_content', 'web3_clientVersion', 'web3_sha3'
];
...
test('payload validation identifies the first unsupported method before batch execution', () => {
  assert.equal(unsupportedForkRpcMethod({ jsonrpc: '2.0', id: 1, method: 'eth_getCode', params: [] }), null);
...
test('unsupported-call error and JSON-RPC response use the stable termination contract', () => {
  ...
  assert.deepEqual(rpcCallNotSupportedResponse({ jsonrpc: '2.0', id: 7, method: 'eth_sendTransaction', params: [] }, error), {
    jsonrpc: '2.0',
    id: 7,
    error: {
      code: -32601,
