...
await fs.copyFile(path.join(root, 'apps', 'web', 'src', 'controller-view-v3.mjs'), path.join(output, 'controller-view.js'));
await fs.copyFile(path.join(root, 'apps', 'web', 'src', 'controller-detail-model-v2.mjs'), path.join(output, 'controller-detail-model-v2.mjs'));
